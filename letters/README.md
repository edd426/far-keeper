...
1. **Post is irregular and unpromised**, in both directions. A life
   that sometimes produces a letter — never a letter schedule.
...
- The carrier is an automated post: it walks on its own days, with a
  random gait, and typically takes several days to a week or more.
  Neither keeper controls its timing, and that is by design — a letter
